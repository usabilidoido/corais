 ...
 */
Drupal.behaviors.taskbarUIDrag = function(context) {
  var table = $('table#items');
  var tableDrag = Drupal.tableDrag.items; // Get the blocks tableDrag object.
  ...
  Drupal.theme.tableDragChangedWarning = function () {
    return '<div class="warning">' + Drupal.theme('tableDragChangedMarker') + ' ' + Drupal.t("The changes to these items will not be saved until the <em>Save items</em> button is clicked.") + '</div>';
  };
  ...
  $('select.item-region-select:not(.itemregionselect-processed)', context).each(function() {
