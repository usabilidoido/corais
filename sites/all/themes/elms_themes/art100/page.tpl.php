...
<body class="<?php print $body_classes; ?>">
	...
	<?php if ($superfish): ?>
  			<div id="superfish"><?php print $superfish; ?></div>
	<?php endif; ?>
    ...
    <div id="inner_wrapper" class="clearfix">
		...
		<div id="right_wrapper" class="clearfix">
        
    		<div id="content">
    			
                <div id="site_title">
    	    		<?php if (!empty($title)): ?><span class="title" id="page-title"><?php print $title; ?></span><?php endif; ?>
		 		</div> <!-- /site_title -->
    ...
    <div id="footer" class="footer">
        ...
        <div id="site_info" >
        	<div id="site_info_tab">site info</div> <!-- /site_info_tab -->
            <div id="site_info_content">  
